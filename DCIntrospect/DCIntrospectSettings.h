...
#define kDCIntrospectKeysCycleSelectedColors            @"s"        // cycles the outline color

// When introspector is invoked and a view is selected //
#define kDCIntrospectKeysToggleSubviewOutlines          @"i"        // shows outlines for all subviews
...
#define kDCIntrospectKeysLogFont                        @"q"
