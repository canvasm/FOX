...
#import "FSPSoccerLeagueScheduleCell.h"
...
@interface FSPSoccerLeagueScheduleCell ()
...
@implementation FSPSoccerLeagueScheduleCell
...
- (void)awakeFromNib;
{
    ...
    self.tvTimeLabel.font = [UIFont fontWithName:FSPClearFOXGothicHeavyFontName size:14.0f];
}
...
- (void)populateWithGame:(FSPScheduleGame *)game;
{
    ...
    self.time.text = [self startTimeStringFromGame:game];
    self.channel.text = game.channelDisplayName;
    self.dateLabel.text = [self startTimeStringFromGame:game];
