//
//  FSPSegmentedNavigationControl.h
//  FoxSports
//
...
extern const CGFloat FSPNavigationViewPreferredHeight;

@interface FSPSegmentedNavigationControl : UIControl

@property (nonatomic, assign) BOOL useDropDown;
